...
#nullable enable
using System.Text;
namespace ArcForges.Contracts.LocalRpc.Notes.Shapes;
...
public static class ContractShapeValidation
{
    ...
    /// <summary>Checks the declared wire/profile constraints of arcforges.local.notes.v1.NotesOperationsServiceTrashDocumentValue.</summary>
    public static bool IsValid([global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)] global::ArcForges.Contracts.LocalRpc.Notes.V1.NotesOperationsServiceTrashDocumentValue? value) => Check(value, new ValidationContext());
    private static bool Check([global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)] global::ArcForges.Contracts.LocalRpc.Notes.V1.NotesOperationsServiceTrashDocumentValue? value, ValidationContext context)
    {
        if (value is null || !context.Enter(value)) return false;
        try
        {
